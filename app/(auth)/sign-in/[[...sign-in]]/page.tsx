        ...
        >
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            <GlowBadge variant="emerald">
              <Sparkles className="w-3 h-3 inline mr-1" /> AI Companion
            </GlowBadge>
            <GlowBadge variant="indigo">
              <ShieldCheck className="w-3 h-3 inline mr-1" /> Private & Secure
            </GlowBadge>
            <GlowBadge variant="amber">
              <Heart className="w-3 h-3 inline mr-1" /> Daily Mindfulness
            </GlowBadge>
          </div>

          <h1 className="text-4xl sm:text-5xl font-extrabold text-[#2d4c2d] leading-tight mb-4">
            <SplitText text="Welcome back to your safe space" />
          </h1>

          <BlurText delay={0.3} className="text-lg text-[#3e5f3e] leading-relaxed mb-8">
            Reconnect with your personal AI companion, track daily mood patterns, and continue your journey toward mental clarity and calm.
          </BlurText>
          ...
          <motion.div
            ...
            className="p-5 rounded-2xl bg-white/60 backdrop-blur-md border border-[#3e5f3e]/20 shadow-lg text-[#2d4c2d]"
          >
            <p className="italic text-sm text-[#3a583a] mb-3">
              &quot;Peace comes from within. Do not seek it without.&quot;
            </p>
            <div className="flex items-center justify-between text-xs font-semibold text-[#4a7a4a]">
              <span>— Buddha</span>
